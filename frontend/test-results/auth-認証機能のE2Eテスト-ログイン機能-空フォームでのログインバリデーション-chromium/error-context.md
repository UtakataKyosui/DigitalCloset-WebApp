...
- Name: 認証機能のE2Eテスト >> ログイン機能 >> 空フォームでのログインバリデーション
- Location: /workspaces/frontend/tests/auth.spec.ts:278:9
...
Locator: getByText('メールアドレスを入力してください')
Expected: visible
Received: <element(s) not found>
Call log:
  - expect.toBeVisible with timeout 5000ms
  - waiting for getByText('メールアドレスを入力してください')

    at /workspaces/frontend/tests/auth.spec.ts:288:56
```
