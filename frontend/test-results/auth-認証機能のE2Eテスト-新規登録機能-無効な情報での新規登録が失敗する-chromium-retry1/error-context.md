...
- Name: 認証機能のE2Eテスト >> 新規登録機能 >> 無効な情報での新規登録が失敗する
- Location: /workspaces/frontend/tests/auth.spec.ts:74:9
...
Locator: getByText('名前を入力してください')
Expected: visible
Received: <element(s) not found>
Call log:
  - expect.toBeVisible with timeout 5000ms
  - waiting for getByText('名前を入力してください')

    at /workspaces/frontend/tests/auth.spec.ts:84:51
```
