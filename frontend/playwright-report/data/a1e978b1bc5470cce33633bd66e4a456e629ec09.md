...
- Name: 認証機能のE2Eテスト >> フォーム切り替え >> 新規登録フォームからログインフォームへの切り替え
- Location: /workspaces/frontend/tests/auth.spec.ts:344:9
...
Call log:
  ...
  - waiting for getByRole('heading', { name: '新規登録' })
    ...
    at /workspaces/frontend/tests/auth.spec.ts:348:65
```
